...
- **Bossing** — worn just **before you enter a room the Bosses table marks as a boss room**, so you fight the boss in dedicated gear; when you leave that room it swaps back (to your movement set if you're still travelling, otherwise Default). **Off by default.**
