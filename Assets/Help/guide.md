...
- **Chest Offload — pricing and selling** — each item has an editable sell quantity (keep some, sell the rest) priced at a **charm** picker, plus a **Drop** button to bin the whole stack. A **Total to sell** figure sums everything selected across all shops.
