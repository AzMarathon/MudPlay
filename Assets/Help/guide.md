...
- **Check for updates (Help menu).** **Help → Check for updates…** opens a small window that tells you whether you're up to date or what the latest version is, shows the download size and the release notes, and offers a **View release notes** link. If a newer build exists, click **Check again** to re-query, or **Download & Restart** to install it.
