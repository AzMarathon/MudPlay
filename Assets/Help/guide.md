...
**A member shut out of the trainer's room.** Some trainers' rooms can't be entered during a fight, so a member still fighting outside is left behind and their follow breaks. The train order carries the trainer's room, so that member walks in by itself once the fight is over, trains, and reports. The leader waits for them, trains itself last, and re-invites everyone who set out on the trip, including a member left in an `[Invited]` slot.
