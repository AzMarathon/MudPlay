...
- **Tab-complete** — completes the word you're typing against the LEADING word of your carried, worn, and key-ring item names (`drop emerald-` + **Tab** → `drop emerald-hilted rapier`; a "bronze emblem" needs `bro`/`bronze`, not `e`). Press it again, or **Shift+Tab**, to step through other matches; toggle it off in **Settings → General**.
