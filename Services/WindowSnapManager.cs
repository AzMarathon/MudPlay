...
public sealed class WindowSnapManager
{
    ...
    // so a fast first drag step can't outrun it). A generous tolerance keeps a snapped
    // panel in the cluster even if a frame edge is a few pixels off; non-snapped panels
    // sit far past it.
