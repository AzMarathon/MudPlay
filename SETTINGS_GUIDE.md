...
1. [General](#general)
2. [Toolbar / Shortcuts](#toolbar--shortcuts)
3. [Keybindings](#keybindings)
4. [Macros & Aliases](#macros--aliases)
5. [BBS + Display (Connection & Network)](#bbs--display-connection--network)
6. [Confirmation Prompts](#confirmation-prompts)
7. [Combat](#combat)
8. [Spells (+ Ailments)](#spells--ailments)
9. [Health](#health)
10. [Party](#party)
11. [Cash](#cash)
12. [Talk](#talk)
13. [Auto-Light](#auto-light)
14. [Auto-Lair](#auto-lair)
15. [Auto-Trainer](#auto-trainer)
16. [Statline](#statline)
17. [Other](#other)
18. [Events](#events)
19. [Sounds (stub — not functional)](#sounds-stub--not-functional)
20. [Diagnostics / Log Pane](#diagnostics--log-pane)
21. [Equipment Sets (Character Workshop)](#equipment-sets-character-workshop)
22. [Command-Line / Environment](#command-line--environment)
23. [Advanced Configuration Reference](#advanced-configuration-reference)
...
A separate system from built-in keybindings above, though the two share the same "can't double-book a key combo" conflict check. Edited through a separate Game Data macro-editor dialog, not the main Settings window.
...
Per-character. Adding, editing, or removing a macro saves to the profile immediately — there's no separate Apply step, unlike most Settings tabs.
...
**Important notes:** Once a spell is announced, it auto-repeats server-side every round exactly like a weapon swing — MudPlay does **not** re-send the cast command every round, only when the situation actually changes (target dies, cap hit, mana too low, target proves immune). A per-monster override configured in Game Data can substitute a different spell or command for a specific monster species, bypassing some of these gates — worth checking if a particular monster seems to ignore your setup here.
