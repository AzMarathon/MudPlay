...
- Buff Watchdog: an arrow button at the top-right of the timer-bar side collapses or expands the config panel (bars-only vs full), styled like the nav map's collapse chip; sticky per character
