...
- Detected by colour + shape (own "You <verb>…"; others' only from a **player actually in your room**), so obvious-exits / wealth / encumbrance green lines and room-entry/exit + party-follow movement are never mistaken for an emote
