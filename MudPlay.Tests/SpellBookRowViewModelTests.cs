...
public sealed class SpellBookRowViewModelTests
{
    ...
    public void Difficulty_IsSpellcastingPlusDiff()
    {
        ...
        Assert.Equal("95%", row.SuccessText);
        Assert.Equal(95, row.SuccessSort);
    }
    ...
    public void Difficulty_NoSpellcasting_ShowsDash()
    {
        ...
        Assert.Equal(-1, row.SuccessSort);
        Assert.Contains("not a caster", row.SuccessTooltip);
    }

    [Fact]
    public void SuccessTooltip_ShowsTheBreakdown()
    {
        ...
        Assert.Equal("Spellcasting 94 + spell difficulty (-5) = 89%", row.SuccessTooltip);
    }

    [Fact]
    public void SuccessTooltip_SpellsOutTheCap()
    {
        ...
        Assert.Contains("= 115%", row.SuccessTooltip);
        Assert.Contains("capped at 98%", row.SuccessTooltip);
    }
