...
public sealed class LeaderDoorAssistManagerTests
{
    ...
    public void LeaderBashFail_TogglesOn_SendsBashSameDirection()
    {
        ...
        h.Line("You see MudPlay attempt to bash the door to the north.");
    ...
    public void LeaderBashFail_PicklocksPreferred_SendsPick()
    {
        ...
        h.Line("You see MudPlay attempt to bash the door to the southeast.");
    ...
    {
        using Harness h = new();
        h.InParty("MudPlay Wuz");

        h.Line("You see MudPlay attempt to bash the door to the up.");
