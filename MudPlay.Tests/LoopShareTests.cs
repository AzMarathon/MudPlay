...
public sealed class LoopShareTests : IDisposable
{
    ...
    public void Receive_AfterOurYes_ReassemblesOutOfOrder_AndSaves()
    {
        ...
        Assert.Equal("[Received loop 'Grand tour' 200 rooms from Raijin]", notices.Single());
    }
    ...
    public void Receive_DifferentLoopUnderOurName_SavedAlongsideIt()
    {
        ...
        Assert.Equal("[Received loop 'King's Road' 3 rooms from Raijin, saved as 'King's Road (from Raijin)']", notices.Single());
    }
    ...
    public void Receive_IdenticalLoopAlreadyHeld_NothingSaved()
    {
        ...
        Assert.Equal("[Received loop 'King's Road' 3 rooms from Raijin, already have it]", notices.Single());
    }
