...
public sealed class BbsRenameCascadeTests : IDisposable
{
    ...
    {
        SeedBbs(_oldBbs);
        SeedProfile(_oldBbs, "MudPlay", _oldBbs);
        ...
        Assert.True(File.Exists(AppPaths.CharacterProfileFile(_newBbs, "MudPlay")));
    ...
    public void RenameBbs_RekeysCredentials_OnUnloadedProfiles()
    {
        ...
        CharacterProfile after = LoadProfile(_newBbs, "MudPlay");
    ...
    public void RenameBbs_UpdatesLoadedProfile_CurrentBbsName_AndInMemoryCredentials()
    {
        ...
        CharacterProfile onDisk = LoadProfile(_newBbs, "MudPlay");
