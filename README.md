...
> - "Respawns @ Cleanup" bosses read a **DEAD / ALIVE** state instead of a countdown — DEAD once marked, flipping back to ALIVE at the BBS's nightly cleanup time (new per-BBS setting in Settings → BBS + display, default 21:00 US Pacific)
