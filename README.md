...
> - Combat log: a new between-round line shows the queued spells' priority order and each buff slot's due / seconds-left state, with the one that fired flagged
>
