...
> **Version 3.86.4**
> - A route blocked only by your level now names the **level gate** (and the level needed) in the picker instead of a generic "blocked" card or an incidental obstacle
