...
public sealed partial class CharacterWorkshopViewModel : ObservableObject, IDisposable
{
        ...
        string? initialSectionId = null)
    {
        ...
        Sections.Add(new CharacterInfoSectionViewModel(playerStats, gameData, inventory, players, alignment, questBonuses, AppServices.Current.Currency, AppServices.Current.ItemCharges, AppServices.Current.ItemUseCounts));
